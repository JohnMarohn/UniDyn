...
To implement our evolution algorithms, we need to define an operator inverse.

\lstinputlisting[linerange=START-END,includerangemarker=false]{unidyn/Inv.m}

\lstinputlisting[linerange=START-END,includerangemarker=false]{unidyn/Inv-tests.m}
