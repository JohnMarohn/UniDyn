...
One of us (JAM) has used the \verb+UniDyn+ package to teach magnetic resonance, multidimensional spectroscopy, relaxation theory, and quantum optics in a graduate quantum mechanics course.
...
Remarkably, \verb+Evolver1+ results could be averaged over orientations analytically and extrapolated to obtain analytical expressions for signal valid in the $N_{\mathrm{spin}} \rightarrow \infty$ limit. Further applications of \verb+Evolver1+, including the effects of the pseudo-secular dipolar coupling and finite pulses, have resulted into significantly improved, yet rapid, data analysis of pulsed dipolar electron spin resonance signals \cite{sinha2024rapid, sinha2026detection}. 

We hope that others will find the \verb+UniDyn+ package as useful as we have.
