...
Crucially, Eq.~\ref{eq:example-spin} makes no reference to a spin quantum number $I$, to a matrix dimension, or to any basis for the operators used.
The same is true for Eq.~\ref{eq:example-ho}, and, indeed, the Fock space in which the oscillator operators act is infinite dimensional. 
