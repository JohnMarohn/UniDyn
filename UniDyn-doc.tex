...
The code was created in the literate-programming style, with \LaTeX{}-style text, equations, and tables interspersed with code in the form of commented-out text.
We use \LaTeX{}'s \verb+lstinputlisting+ package to import the code and typeset it nicely.
