...
\title{
  The UniDyn \emph{Mathematica} package obtains
  unitary quantum-mechanical operator rotations from commutation relations}
...
Ithaca, NY, USA 14851-1301 \vspace{8pt}}

\affil[2]{East Millpond Electromagnetics \authorcr
464 72 Ave.\ NE \authorcr Calgary, AB, Canada T2E 7C3}
...
{Sp\$sym}{{\ensuremath{S_{+}}}}1
{Sm\$sym}{{\ensuremath{S_{-}}}}1
...
% ==========================
\section{Performing unitary transformations}
% ==========================
...
\input{tex/UniDyn-doc--acknowledgments.tex}
