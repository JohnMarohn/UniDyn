...
Iz$sym /: Mult[a___,Iz$sym,Iz$sym,b___] := Mult[a,b]/4;
Iy$sym /: Mult[a___,Iy$sym,Iy$sym,b___] := Mult[a,b]/4;
Ix$sym /: Mult[a___,Ix$sym,Ix$sym,b___] := Mult[a,b]/4;

Iz$sym /:  Mult[a___,Iz$sym,Ix$sym,b___] :=  I Mult[a,Iy$sym,b]/2;
Iz$sym /:  Mult[a___,Iz$sym,Iy$sym,b___] := -I Mult[a,Ix$sym,b]/2;

Iy$sym /:  Mult[a___,Iy$sym,Ix$sym,b___] := -I Mult[a,Iz$sym,b]/2;
Iy$sym /:  Mult[a___,Iy$sym,Iz$sym,b___] :=  I Mult[a,Ix$sym,b]/2;

Ix$sym /:  Mult[a___,Ix$sym,Iz$sym,b___] := -I Mult[a,Iy$sym,b]/2;
Ix$sym /:  Mult[a___,Ix$sym,Iy$sym,b___] :=  I Mult[a,Iz$sym,b]/2;
